...
void runModeA() {
  ...
  if(distance < 20) {
    ...
    switch(followerSensor.readSensors()) {
      ...
      case 1:
        leftMotor.run(SPEED_1);
        rightMotor.run(SPEED_1);
        break;
